  ...
  outputs =
    ...
    in
    {
      nixosConfigurations = {
        ...
        raftchat3 = nixpkgs.lib.nixosSystem {
          system = "x86_64-linux";
          modules = [
            baseModule
            ./common/configuration.nix
            ./hosts/raftchat3/hardware-configuration.nix
        ...
        raftchat5 = nixpkgs.lib.nixosSystem {
          system = "x86_64-linux";
          modules = [
            baseModule
            ./common/configuration.nix
            ./hosts/raftchat5/hardware-configuration.nix
            { networking.hostName = "raftchat5"; }
          ];
        };
      };
    };
